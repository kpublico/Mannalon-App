                    ...
                    <div class="grid-responsive">
                        <div class="form-group">
                            ...
                            >
                                ...
                                <option value="Aparri" {{ old('city') === 'Aparri' ? 'selected' : '' }}>Aparri</option>
                                <option value="Ballesteros" {{ old('city') === 'Ballesteros' ? 'selected' : '' }}>Ballesteros</option>
                                <option value="Buguey" {{ old('city') === 'Buguey' ? 'selected' : '' }}>Buguey</option>
                                <option value="Camalaniugan" {{ old('city') === 'Camalaniugan' ? 'selected' : '' }}>Camalaniugan</option>
                                <option value="Claveria" {{ old('city') === 'Claveria' ? 'selected' : '' }}>Claveria</option>
                                <option value="Enrile" {{ old('city') === 'Enrile' ? 'selected' : '' }}>Enrile</option>
                                <option value="Gattaran" {{ old('city') === 'Gattaran' ? 'selected' : '' }}>Gattaran</option>
                                <option value="Iguig" {{ old('city') === 'Iguig' ? 'selected' : '' }}>Iguig</option>
                                <option value="Lal-lo" {{ old('city') === 'Lal-lo' ? 'selected' : '' }}>Lal-lo</option>
                                <option value="Pamplona" {{ old('city') === 'Pamplona' ? 'selected' : '' }}>Pamplona</option>
                                <option value="Penablanca" {{ old('city') === 'Penablanca' ? 'selected' : '' }}>Penablanca</option>
                                <option value="Piat" {{ old('city') === 'Piat' ? 'selected' : '' }}>Piat</option>
                                <option value="Sanchez-Mira" {{ old('city') === 'Sanchez-Mira' ? 'selected' : '' }}>Sanchez-Mira</option>
                                <option value="Santa Ana" {{ old('city') === 'Santa Ana' ? 'selected' : '' }}>Santa Ana</option>
                                <option value="Solano" {{ old('city') === 'Solano' ? 'selected' : '' }}>Solano</option>
                                <option value="Tuguegarao City" {{ old('city') === 'Tuguegarao City' ? 'selected' : '' }}>Tuguegarao City</option>
                            </select>
        ...
        function addressForm() {
            return {
                ...
                init() {
                    ...
                    this.selectedMunicipality = '{{ old('city') ?? '' }}';
