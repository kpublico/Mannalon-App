            ...
            <header class="bg-white shadow-md px-4 md:px-6 py-4 flex items-center justify-between border-b-4 border-emerald-600 flex-shrink-0">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 md:gap-3 mb-1 flex-wrap">
                        ...
                        <span class="px-2 md:px-3 py-1 {{ $isSuperAdmin ? 'bg-indigo-700' : 'bg-red-600' }} text-white text-xs font-bold rounded-full">{{ $isSuperAdmin ? 'SUPER ADMIN' : 'ADMIN' }}</span>
                    </div>
                ...
                <div class="flex items-center gap-2 md:gap-4 flex-shrink-0">
                    ...
                    <div class="flex items-center gap-2 md:gap-3">
                        <div class="text-right hidden sm:block">
                            ...
                            <p class="text-xs text-gray-500">{{ $isSuperAdmin ? 'System Owner' : 'Admin' }}</p>
                        </div>
