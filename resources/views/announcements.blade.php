    ...
    <nav class="emerald-gradient text-white px-6 py-4 shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="{{ route('announcements') }}" class="hover:text-emerald-100 transition font-bold">Announcements</a>
                <a href="{{ route('guides') }}" class="hover:text-emerald-100 transition">Guides</a>
                <a href="{{ route('weather') }}" class="hover:text-emerald-100 transition">Weather</a>
                <a href="{{ route('market-prices') }}" class="hover:text-emerald-100 transition">Market Prices</a>
                <a href="{{ route('about') }}" class="hover:text-emerald-100 transition">About</a>
                @auth
                    <div class="flex items-center gap-3">
                        <span class="text-emerald-50">Farmer Account</span>
                        <a href="{{ route('profile') }}" class="hover:text-emerald-100 transition bg-white/20 px-3 py-1 rounded-full flex items-center gap-2">
