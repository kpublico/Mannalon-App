    ...
    <div class="header-bar">
        <div class="user-info">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">{{ ucfirst(auth()->user()->role) }} • {{ auth()->user()->barangay ?? 'N/A' }}</p>
            </div>
        </div>
        ...
        <div class="p-6 max-w-7xl mx-auto">
            ...
            <div class="emerald-gradient text-white rounded-lg p-8 mb-8 wave-pattern">
                <div class="flex justify-between items-start relative z-10">
                    <div>
                        <h2 class="text-3xl font-bold mb-2">Welcome to MannalonApp, {{ auth()->user()->name }}!</h2>
                ...
                <div class="stat-card bg-white p-6 rounded-lg shadow-sm border-t-4 border-emerald-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">{{ $activeRequests ?? 0 }}</p>
                        </div>
                ...
                <div class="stat-card bg-white p-6 rounded-lg shadow-sm border-t-4 border-yellow-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">₱{{ $subsidiesReady ?? '0' }}</p>
                        </div>
                ...
                <div class="stat-card bg-white p-6 rounded-lg shadow-sm border-t-4 border-blue-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">{{ $completedHarvests ?? 0 }}</p>
                        </div>
                ...
                <div class="stat-card bg-white p-6 rounded-lg shadow-sm border-t-4 border-red-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">{{ $alerts ?? 0 }}</p>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <span class="text-2xl">{{ auth()->user()->role === 'farmer' ? '✓' : '⏳' }}</span>
    ...
    @elseif(auth()->user()->role === 'admin')
        ...
        <div class="p-6 max-w-7xl mx-auto">
            ...
            <div class="emerald-gradient text-white rounded-lg p-8 mb-8 wave-pattern">
                <div class="flex justify-between items-start relative z-10">
                    <div>
                        ...
                        <p class="text-emerald-50">Overview for Municipality of {{ auth()->user()->city ?? 'Buguey' }}</p>
                    </div>
                    <div class="flex gap-3">
                        <button class="bg-white text-emerald-700 px-6 py-2 rounded-lg font-semibold hover:bg-emerald-50 transition">
                            📝 Post Announcement
            ...
            <div class="alert-badge bg-red-100 border-l-4 border-red-500 text-red-800 p-4 rounded mb-8 flex items-center gap-3">
                ...
                <div>
                    <p class="font-bold">{{ $pendingVerifications }} Pending Verifications</p>
                ...
                <div class="stat-card bg-white p-6 rounded-lg shadow-sm border-t-4 border-emerald-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">{{ $totalFarmers ?? 0 }}</p>
                        </div>
                        <div class="text-4xl text-emerald-500">👨‍🌾</div>
                    </div>
                </div>
                ...
                <div class="stat-card bg-white p-6 rounded-lg shadow-sm border-t-4 border-yellow-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">{{ $pendingVerifications ?? 0 }}</p>
                        </div>
                        <div class="text-4xl text-yellow-500">⏳</div>
                    </div>
                </div>
                ...
                <div class="stat-card bg-white p-6 rounded-lg shadow-sm border-t-4 border-blue-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">{{ $distributionRequests ?? 0 }}</p>
                        </div>
                        <div class="text-4xl text-blue-500">📦</div>
                    </div>
                </div>
                ...
                <div class="stat-card bg-white p-6 rounded-lg shadow-sm border-t-4 border-red-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">{{ $systemAlerts ?? 0 }}</p>
                        </div>
                        <div class="text-4xl text-red-500">🚨</div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            {{-- Replace this with dynamic data from controller --}}
