...
return [
    ...
    | store your users' sessions. Sessions will be stored locally by default.
    |
    ...
    */
    ...
    | elapse before the user is asked to re-authenticate again. This is
    | mostly useful when quickly accessing protected resources that are
    | in high demand.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Determines if your session will be expired on close of browser. A null
    | value means that this setting is not set and the session will persist
    | until the user manually logs out or after a set lifetime.
    |
    */
    ...
    | session data should be encrypted. All encryption keys will be run
    | through the hash function to generate a suitable encryption key.
    |
    */
    ...
    */
    ...
    | instance with the user's browser. The default is "LARAVEL_SESSION".
    |
    */
