...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Admin Panel | MannalonApp</title>
...
<body class="bg-gray-100">
            ...
            <div class="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-emerald-100"><?php echo e($isSuperAdmin ? 'Super Admin Control Panel' : 'Admin Control Panel'); ?></p>
                    </div>
                </div>
                <div class="mt-3 bg-white/20 rounded-lg px-3 py-2">
                    <p class="text-xs text-emerald-100">Welcome back</p>
                    <p class="text-sm font-semibold text-white"><?php echo e(auth()->user()->name ?? 'Administrator'); ?></p>
                </div>
            </div>

            <nav class="p-4 space-y-2 overflow-y-auto" style="max-height: calc(100vh - 180px);">
                <a href="javascript:void(0)" onclick="loadAdminPage('dashboard', '<?php echo e(route('admin.dashboard')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg active" data-page="dashboard">
                    <i class="fas fa-chart-line w-5"></i>
                    <span>Dashboard</span>
                </a>

                <?php if($isSuperAdmin): ?>
                    <a href="javascript:void(0)" onclick="loadAdminPage('users', '<?php echo e(route('admin.users.index')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="users">
                        <i class="fas fa-user-shield w-5"></i>
                        <span>User Management</span>
                    </a>

                    <a href="javascript:void(0)" onclick="loadAdminPage('reports-analytics', '<?php echo e(route('admin.reports-analytics')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="reports-analytics">
                        <i class="fas fa-chart-pie w-5"></i>
                        <span>Global Reports</span>
                    </a>

                    <a href="javascript:void(0)" onclick="loadAdminPage('settings', '<?php echo e(route('admin.settings')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="settings">
                        <i class="fas fa-cog w-5"></i>
                        <span>System Settings</span>
                    </a>
                <?php else: ?>
                    <a href="javascript:void(0)" onclick="loadAdminPage('farmers', '<?php echo e(route('admin.farmers.index')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="farmers">
                        <i class="fas fa-users w-5"></i>
                        <span>Farmer Information</span>
                    </a>

                    <a href="javascript:void(0)" onclick="loadAdminPage('announcements', '<?php echo e(route('admin.announcements.index')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="announcements">
                        <i class="fas fa-bullhorn w-5"></i>
                        <span>Announcements</span>
                    </a>

                    <a href="javascript:void(0)" onclick="loadAdminPage('guides', '<?php echo e(route('admin.guides.index')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="guides">
                        <i class="fas fa-book-open w-5"></i>
                        <span>Farming Guides</span>
                    </a>

                    <a href="javascript:void(0)" onclick="loadAdminPage('weather', '<?php echo e(route('admin.weather.index')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="weather">
                        <i class="fas fa-cloud-sun w-5"></i>
                        <span>Weather Updates</span>
                    </a>

                    <a href="javascript:void(0)" onclick="loadAdminPage('market-prices', '<?php echo e(route('admin.market-prices.index')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="market-prices">
                    ...
                    <a href="javascript:void(0)" onclick="loadAdminPage('land-management', '<?php echo e(route('admin.land.index')); ?>')" class="sidebar-nav-link admin-sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg" data-page="land-management">
    ...
    <script>
        ...
        const pageInfo = <?php echo json_encode($pageInfoData, 15, 512) ?>;
        ...
        function verifyFarmer(farmerId) {
            ...
            .then(data => {
                ...
                const currentRoute = currentPage === 'dashboard' 
                    ...
                    : (currentPage === 'farmers' ? '<?php echo e(route('admin.farmers.index')); ?>' : '<?php echo e(route('admin.dashboard')); ?>');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            loadAdminPage('dashboard', '<?php echo e(route('admin.dashboard')); ?>');
        });
...
<?php /**PATH C:\Users\jayso\Desktop\dev\web\Mannalon-App\resources\views/layouts/admin-dashboard.blade.php ENDPATH**/ ?>