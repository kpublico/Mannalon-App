                ...
                <div class="p-8 md:p-12 bg-white">
                    ...
                    <form method="POST" action="<?php echo e(route('login.store')); ?>" class="space-y-5">
                        ...
                        <?php if(session('success')): ?>
                            <div class="bg-emerald-50 border-l-4 border-emerald-500 p-4 rounded mb-4">
                                <p class="text-emerald-700 font-semibold text-sm mb-1 flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    Success!
                                </p>
                                <p class="text-emerald-600 text-sm"><?php echo e(session('success')); ?></p>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="mt-8 space-y-4 border-t border-gray-200 pt-6">
                        <p class="text-center text-gray-700 text-sm">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="font-semibold text-emerald-600 link-hover hover:text-emerald-700">
                                Create Account
                            </a>
                        </p>
                        <div class="text-center">
                            <a href="<?php echo e(url('/')); ?>" class="text-sm text-gray-600 link-hover hover:text-gray-900 flex items-center justify-center gap-1">
                                ← Back to Home
                            </a>
                        </div>
                    </div>
