                        ...
                        <?php $__empty_1 = true; $__currentLoopData = ($recentFarmers ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $farmer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-emerald-50">
                                ...
                                <td class="px-4 py-3 text-sm space-x-2 flex gap-2">
                                    <button onclick="loadAdminPage('farmer-detail', '<?php echo e(route('admin.farmers.show', $farmer->id)); ?>')" class="px-3 py-1 bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 transition font-semibold text-xs" title="View Details"><i class="fas fa-eye mr-1"></i>View</button>
                                    <button onclick="verifyFarmer(<?php echo e($farmer->id); ?>)" class="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-md hover:bg-emerald-200 transition font-semibold text-xs" title="Verify Farmer"><i class="fas fa-check mr-1"></i>Verify</button>
                                </td>
                            </tr>
