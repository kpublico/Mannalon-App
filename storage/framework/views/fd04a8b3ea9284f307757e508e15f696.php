...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-card" id="address-section">
                    <!-- Section Header -->
                    <div class="section-header">
                        <svg class="section-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        // ---- Dynamic Address Dropdowns (PSGC data) ----
        (() => {
            const regionSel   = document.getElementById('reg_region');
            const provinceSel = document.getElementById('reg_province');
            ...
            async function loadRegions() {
                try {
                    ...
                    data.forEach(r => {
                        ...
                        if (r.name === oldRegion) opt.selected = true;
            ...
            async function loadProvinces(regionCode) {
                ...
                try {
                    ...
                    data.forEach(p => {
                        ...
                        if (p.name === oldState) opt.selected = true;
            ...
            async function loadCities(provinceCode) {
                ...
                try {
                    ...
                    data.forEach(c => {
                        ...
                        if (c.name === oldCity) opt.selected = true;
            ...
            async function loadBarangays(cityCode) {
                ...
                try {
                    ...
                    data.forEach(b => {
                        ...
                        if (b.name === oldBarangay) opt.selected = true;
