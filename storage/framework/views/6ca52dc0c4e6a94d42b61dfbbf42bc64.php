...
<?php $__env->startSection('page-title', 'Create New Farming Guide'); ?>
<?php $__env->startSection('page-subtitle', 'Add a new farming guide for farmers with optional video link'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-8">
        <form method="POST" action="<?php echo e(route('admin.guides.store')); ?>" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <input type="text" name="title" value="<?php echo e(old('title')); ?>" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-emerald-600" placeholder="e.g., How to Plant Palay" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="crop_type" value="<?php echo e(old('crop_type')); ?>" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-emerald-600" placeholder="Palay, Corn, Vegetables, Fruits, etc.">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="url" name="resource_url" value="<?php echo e(old('resource_url')); ?>" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-emerald-600" placeholder="https://youtube.com/watch?v=... or any resource link">
...
<?php echo $__env->make('layouts.admin-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Mannalon_App\resources\views\admin\guides\create.blade.php ENDPATH**/ ?>