    ...
    <nav class="emerald-gradient text-white px-6 py-4 shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="<?php echo e(route('weather.public')); ?>" class="hover:text-emerald-100 transition">Weather</a>
                <a href="<?php echo e(route('market-prices.public')); ?>" class="hover:text-emerald-100 transition">Market Prices</a>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-emerald-600 px-4 py-2 rounded-lg font-semibold hover:bg-emerald-50 transition">Register</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div class="bg-white p-6 rounded-lg shadow-sm">
                <p class="text-4xl font-bold text-emerald-600 mb-2"><?php echo e($totalFarmers ?? 0); ?></p>
                <p class="text-gray-600">Registered Farmers</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-sm">
                <p class="text-4xl font-bold text-blue-600 mb-2"><?php echo e($municipalities ?? 15); ?></p>
                <p class="text-gray-600">Municipalities</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-sm">
                <p class="text-4xl font-bold text-yellow-600 mb-2"><?php echo e($crops ?? 0); ?></p>
                <p class="text-gray-600">Crops Tracked</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-sm">
                <p class="text-4xl font-bold text-green-600 mb-2"><?php echo e($activePrograms ?? 8); ?></p>
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-emerald-500 hover:shadow-md transition">
                    ...
                    <a href="<?php echo e(route('announcements')); ?>" class="text-emerald-600 font-semibold text-sm hover:underline">Read more →</a>
                </div>
            ...
            <div class="text-center mt-6">
                <a href="<?php echo e(route('announcements')); ?>" class="inline-block px-6 py-2 bg-emerald-600 text-white rounded-lg font-semibold hover:bg-emerald-700 transition">View All Announcements</a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-white p-8 rounded-lg shadow-sm">
                ...
                <a href="<?php echo e(route('weather.public')); ?>" class="inline-block mt-4 text-emerald-600 font-semibold hover:underline">View Detailed Weather →</a>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg shadow-sm">
                ...
                <a href="<?php echo e(route('market-prices.public')); ?>" class="inline-block mt-4 text-emerald-600 font-semibold hover:underline">View All Prices →</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-8 mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="<?php echo e(route('guides')); ?>" class="p-6 border-2 border-gray-200 rounded-lg hover:border-emerald-500 hover:shadow-md transition">
                ...
                <a href="<?php echo e(route('weather.public')); ?>" class="p-6 border-2 border-gray-200 rounded-lg hover:border-emerald-500 hover:shadow-md transition">
                ...
                <a href="<?php echo e(route('market-prices.public')); ?>" class="p-6 border-2 border-gray-200 rounded-lg hover:border-emerald-500 hover:shadow-md transition">
                    <p class="text-3xl mb-2">💵</p>
...
<?php /**PATH C:\xampp\htdocs\Mannalon_App\resources\views\home.blade.php ENDPATH**/ ?>