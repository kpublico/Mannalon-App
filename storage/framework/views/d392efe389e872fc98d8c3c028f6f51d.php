...
<script>
    (function () {
        const points = <?php echo json_encode($farmDetails->map(function ($item) {
            return [
                'name' => optional($item->farmer)->name ?? 'Unknown Farmer', 'latitude' => (float) $item->latitude, 'longitude' => (float) $item->longitude) ?>;
...
<?php /**PATH C:\Users\jayso\Desktop\dev\web\Mannalon-App\resources\views/admin/land-management-content.blade.php ENDPATH**/ ?>