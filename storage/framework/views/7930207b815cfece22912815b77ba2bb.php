    ...
    <nav class="emerald-gradient text-white px-6 py-4 shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="<?php echo e(route('guides')); ?>" class="hover:text-emerald-100 transition font-bold">Guides</a>
...
<?php /**PATH C:\xampp\htdocs\Mannalon_App\resources\views\guides.blade.php ENDPATH**/ ?>