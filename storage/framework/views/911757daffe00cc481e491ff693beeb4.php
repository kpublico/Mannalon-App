                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex justify-center gap-2">
                                    <button type="button" onclick="window.location.href='<?php echo e(route('admin.announcements.edit', $announcement->id)); ?>'" class="px-3 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700">Edit</button>
...
<?php /**PATH C:\Users\jayso\Desktop\dev\web\Mannalon-App\resources\views/admin/announcements-content.blade.php ENDPATH**/ ?>