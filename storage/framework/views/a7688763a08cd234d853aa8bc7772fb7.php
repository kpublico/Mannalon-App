            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <a href="<?php echo e(route('register')); ?>" class="inline-block px-8 py-3 bg-white text-emerald-700 font-bold rounded-lg hover:bg-gray-100 transition">
                            Create Account
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="inline-block px-8 py-3 border-2 border-white text-white font-bold rounded-lg hover:bg-white hover:bg-opacity-10 transition">
                            Log In
                        </a>
                    </div>
                </div>
    ...
    <section id="contact" class="py-20 bg-gradient-to-r from-emerald-900 to-emerald-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-20">
                ...
                <a href="<?php echo e(route('register')); ?>" class="inline-block px-10 py-4 bg-white text-emerald-700 font-bold text-lg rounded-lg hover:bg-gray-100 transition shadow-lg">
                    Create Free Account
                </a>
            </div>
...
<?php /**PATH C:\Users\jayso\Desktop\dev\web\Mannalon-App\resources\views/welcome.blade.php ENDPATH**/ ?>