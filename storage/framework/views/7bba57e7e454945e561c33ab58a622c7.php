...
<body class="bg-white">
    ...
    <section class="hero-gradient pt-20 pb-12 text-white mt-16 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div class="hero-text">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                        <a href="<?php echo e(route('register')); ?>" class="inline-block px-6 sm:px-8 py-2.5 md:py-3 bg-white text-emerald-700 font-bold text-sm md:text-base rounded-lg hover:bg-gray-100 transition text-center">
                            Create Account
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="inline-block px-6 sm:px-8 py-2.5 md:py-3 border-2 border-white text-white font-bold text-sm md:text-base rounded-lg hover:bg-white hover:bg-opacity-10 transition text-center">
                            Log In
                        </a>
                    </div>
                </div>
            ...
            <!-- Quick Stats -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mt-12 md:mt-16">
                <div class="stat-card bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-4 md:p-6 hover:bg-opacity-30 transition-all">
                    <div class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2"><?php echo e(number_format($activeFarmers)); ?>+</div>
                    <p class="text-sm md:text-base text-emerald-100">Active Farmers</p>
                </div>
                <div class="stat-card bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-4 md:p-6 hover:bg-opacity-30 transition-all">
                    <div class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2"><?php echo e(number_format($monitoredFarms)); ?>+</div>
                    <p class="text-sm md:text-base text-emerald-100">Monitored Farms</p>
                </div>
                <div class="stat-card bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-4 md:p-6 hover:bg-opacity-30 transition-all">
                    <div class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2"><?php echo e(number_format($tonsHarvested, 1)); ?>M+</div>
    ...
    <section id="services" class="py-12 md:py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10 md:mb-16">
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">Available Services</h2>
                <p class="text-base md:text-xl text-gray-600">Comprehensive tools to manage every aspect of your farming operation</p>
            </div>
    ...
    <section id="contact" class="py-12 md:py-20 bg-gradient-to-r from-emerald-900 to-emerald-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12 md:mb-20">
                ...
                <a href="<?php echo e(route('register')); ?>" class="inline-block px-6 md:px-10 py-2.5 md:py-4 bg-white text-emerald-700 font-bold text-sm md:text-lg rounded-lg hover:bg-gray-100 transition shadow-lg">
                    Create Free Account
                </a>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Mannalon_App\resources\views/welcome.blade.php ENDPATH**/ ?>