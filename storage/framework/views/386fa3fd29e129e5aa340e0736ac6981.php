...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - MannalonApp</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-md px-6 py-4 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo $__env->yieldContent('page-subtitle', 'Welcome to your dashboard'); ?></p>
                </div>
                <div class="flex items-center gap-4">
                    <div class="text-right">
                        <p class="text-sm font-semibold text-gray-800"><?php echo e(auth()->user()->name ?? 'Farmer'); ?></p>
...
</html><?php /**PATH C:\Users\jayso\Desktop\dev\web\Mannalon-App\resources\views/layouts/farmer-dashboard.blade.php ENDPATH**/ ?>